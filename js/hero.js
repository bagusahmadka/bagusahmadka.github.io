export function renderHero() {
    ...
    <header id="hero" class="bg-gradient-to-br from-indigo-600 to-purple-600 text-white pt-24 pb-16 md:pt-32 md:pb-24 min-h-screen flex items-center">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="w-32 h-32 md:w-40 md:h-40 mx-auto mb-6 relative reveal reveal-up">
            ...
            <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold mb-2 reveal reveal-up" style="transition-delay: 200ms;">
                Halo, Saya <span class="text-yellow-300">Bagus Ahmad Khoirul Ato'</span>
            </h1>
            <h2 class="text-xl sm:text-2xl md:text-3xl font-medium mb-6 text-indigo-100 reveal reveal-up" style="transition-delay: 300ms; min-height: 36px;">
                Saya seorang <span id="typing-text" class="text-yellow-300 typing-cursor"></span>
            </h2>
            <p class="text-lg sm:text-xl md:text-2xl text-indigo-100 mb-8 max-w-2xl mx-auto reveal reveal-up" style="transition-delay: 400ms;">
            ...
            <div class="space-y-4 sm:space-y-0 sm:space-x-4 reveal reveal-up" style="transition-delay: 600ms;">
